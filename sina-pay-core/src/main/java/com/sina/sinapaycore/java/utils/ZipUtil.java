...
public class ZipUtil
{
	...
	{// zipDirectoryPath:需要压缩的文件夹名
		...
		{
			LOG.error("【SDK 异常】", ioe);
			throw new SDKException(ioe.getMessage());
		}
	}
	...
	/*
	 * //测试Zip类 public static void main(String[] args)throws Exception{
	 * 
	 * ZipUtil zip = new ZipUtil(); //
	 * zip.unZip("E:\\weibopay\\temp\\sitemesh3_freemarker_springmvc.zip"); //
	 * zip.doZip("F:\\20160829173928"); zip.unZip("F:\\20160829183246.zip"); }
	 */
}
